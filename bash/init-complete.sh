...
echo -en "\e[38;5;194mIf everything looks good in the above results then \npush the newly created project files to your git repo and get started coding your project\e[0m"