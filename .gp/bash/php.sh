...
#php8_0='php8.0 php8.0-fpm php8.0-dev libapache2-mod-php8.0 php8.0-bcmath php8.0-curl php8.0-gd php8.0-intl php8.0-mbstring php8.0-mysql'
php8_0='php8.0 php8.0-dev php8.0-bcmath php8.0-ctype php8.0-curl php8.0-gd php8.0-intl php8.0-mbstring php8.0-mysql php8.0-pgsql php8.0-sqlite3 php8.0-tokenizer php8.0-xml php8.0-zip'
