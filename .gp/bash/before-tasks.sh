...
bash .gp/bash/utils.sh add_file_to_file_after "\\[alias\\]" bash/snippets/emoji-log ~/.gitconfig &&
bash .gp/bash/utils.sh add_file_to_file_after "\\[alias\\]" bash/snippets/git-aliases ~/.gitconfig &&
log_silent "$msg" &&
